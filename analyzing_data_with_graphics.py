...
while True:
    ...
    if goal_value > 9999 or actual_value > 9999:
        ...
        goal_value = int(goal_value)
        g_size_goal = int(goal_value / 1000)

        actual_value = int(actual_value)
        g_size_actual = int(actual_value / 1000)
    ...
    elif goal_value > 9 or actual_value > 9:

        goal_value = int(goal_value)
        g_size_goal = int(goal_value)

        actual_value = int(actual_value)
        g_size_actual = int(actual_value)
