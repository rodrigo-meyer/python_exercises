...
while True:
    ...
    if goal_value >= 10000 or actual_value >= 10000:

        goal_value = int(goal_value)
        g_size_goal = int(goal_value / 1000000)
        actual_value = int(actual_value)
        g_size_actual = int(actual_value / 1000000)

    elif goal_value >= 1000 or actual_value >= 1000:
    ...
    elif goal_value >= 100 or actual_value >= 100:
    ...
    elif goal_value >= 10 or actual_value >= 10:
