...
print('For angle \033[4;30;43m {:.2f} \033[m, the sine is \033[4;30;43m {:.2f} \033[m,'.format(angle,sin)

cosine = cos(radians(angle))
print('For angle \033[4;30;43m {:.2f} \033[m, the cosine is \033[4;30;43m {:.2f} \033[m,'.format(angle,cosin)
